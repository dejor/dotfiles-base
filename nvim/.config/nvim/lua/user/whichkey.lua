...
local mappings = {
  ...
  g = {
    name = "Git",
    -- g = { "<cmd>lua _LAZYGIT_TOGGLE()<CR>", "Lazygit" }, -- replace with gitui maybe ??
  ...
  l = {
    ...
    d = {
      ...
      k = { "<cmd>Lspsaga show_cursor_diagnostics<cr>", "Show line diagnostics" },
